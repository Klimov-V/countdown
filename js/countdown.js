(() => {
    ...
    class Countdown {
        ...
        _secinds_per_day = 60 * 60 * 24;
        _secinds_per_hour = 60 * 60;
        _secinds_per_minute = 60;
        ...
        display() {
            ...
            // document.write(`${this.days} : ${hours} : ${minutes} : ${seconds}`);
        }
        ...
        calc() {
            ...
            this.days = Math.floor(tmp / this._secinds_per_day);
            tmp = tmp - this.days * this._secinds_per_day;

            this.hours = Math.floor(tmp / this._secinds_per_hour);
            tmp = tmp - this.hours * this._secinds_per_hour;

            this.minutes = Math.floor(tmp / this._secinds_per_minute);
            tmp = tmp - this.minutes * this._secinds_per_minute;
